...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_MAIN_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_DL_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_MASTER_PRIO, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_DL_PRIO, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_NUM_PORTS, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_DIAG_ENTRIES, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_MAX_EVENTS, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IOLINK_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_IOLINK_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RTC_CLK_SRC_INT_RC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RTC_CLK_CAL_CYCLES, 1024);
